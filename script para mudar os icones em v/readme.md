To implement this for *.v files, please,

update `sudo nano /usr/share/mime/packages/freedesktop.org.xml`
...
```xml
  <mime-type type="text/x-v">
    <comment>Vlang MIME Type</comment>
    <comment xml:lang="pt_BR">Código-fonte Vlang</comment>
    <sub-class-of type="text/plain"/>
    <glob pattern="*.v"/>
    <glob pattern="*.vv"/>
    <glob pattern="*.vsh"/>
